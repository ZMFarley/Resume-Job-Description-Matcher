        ...
        <div>
            ...
            {page === "submit" && (
                <div className="center">
                    <h1 className="title">Resume and Job Description Matcher</h1>
                    <h2>This tool will intake your resume and a job description, and tell you how good of a fit you are for the job!</h2>
                    ...
                    <button className="startingButton" onClick={uploadImage}>Click to submit to the matcher</button>
                </div> )}
